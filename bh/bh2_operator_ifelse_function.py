...
a, b = 50, 5  # tạo nhiều biến trên 1 dòng
print(a + b)
print(a - b)
print(a * b)
print(a / b)
...
"""
def my_function(name, subname):
    print(name + subname + " Nguyen")

my_function("Tu", "Ngoc")


def my_function(name, sub="Ngoc"):  # function can have default parameter
    print(name + " Nguyen " + sub)


my_function("An")
my_function(name="An", sub="Hoang")
