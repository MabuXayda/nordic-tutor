...
path_local = "E:/Study/python/nc_python_analysis/automobile"
...
- We can also read/save other data format:
    ...
    + ...    
"""
df.to_csv("E:/Study/python/nc_python_analysis/automobile.csv", index=False)
...
temp_0 = df["num-of-doors"].isnull()
temp = df[df["num-of-doors"].isnull()]
...
plt.savefig("E:/Study/python/nc_python_analysis/tutorial/horse.png")
