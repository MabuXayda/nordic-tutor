...
"""
x = "Hello World !, hom nay la ngay 12"
x = 10
x = 10.7
x = [1, 2, 3, 4, 5]
x = ["Nguyen", "Ngoc", "Tu"]
...
#txt = "I want to pay " + 3 + " dollars for itemID " + 1199
...
print("I want to pay " + str(quantity) + " dollars for itemID " + str(itemno))
print("I want to pay {} dollars for itemID {}".format(quantity, itemno))
